      ...
      <div className="w-full shadow subpixel-antialiased rounded min-h-64 bg-zinc-800 dark:bg-zinc-700 border-black dark:border-white mx-auto">
        ...
        >
          <p className="mt-1 pl-1 text-lg font-bold">
            <TypingEffect text="Hii, I'm Lina Mahrouch 👋" />
          </p>
          <p className="pl-1 pb-1 text-1em">
            A Frontend Software Engineer, professional Valorant player, and
            competitive tennis enthusiast based in Morocco. I have a passion for
            creating impactful fullstack web applications with React and its
          ...
          <p className="pl-1 pb-1">
            {' '}
            Precision defines me, both in the digital realm and on the court.{' '}
          </p>
