                    ...
                    <div className='flex justify-between h-16'>
                        <div className='flex justify-between w-full'>
                            ...
                            <div className='hidden sm:nl-6 sm:flex sm:space-x-8'>
                                ...
                                <NavLink className={({ isActive }) => isActive ? 'border-purple-900  dark:text-white h-full inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium' : "border-transparent text-gray-500 dark:text-gray-300 dark:hover:text-white inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"}
                                    to="/">
                                    Home
