...
const Index = () => {
  return (
    <div className="mb-2 ">
      <div className='space-y-2 pt-6 pb-10  md:space-x-3'>
      

      </div>

      <div className="spacey-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        <div className="flex flex-col pl-4 pt-8 ">
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className=" text-2xl   pt-2 pb-2 text-zinc-900 dark:text-slate-200 r font-bold leading-8 tracking-tight"
          >
